...
class ConditionalDDPM(EnVariationalDiffusion):
    ...
    def sample_p_xh_given_z0(self, z0_lig, xh0_pocket, lig_mask, pocket_mask,
        ...
        net_out_lig, _ = self.dynamics(
            z0_lig, xh0_pocket, t_zeros, lig_mask, pocket_mask, context)
    ...
    def forward(self, ligand, pocket, return_info=False):
        ...
        net_out_lig, _ = self.dynamics(
            z_t_lig, xh_pocket, t, ligand['mask'], pocket['mask'], context)
        ...
        if self.training:
            ...
            net_out_0_lig, _ = self.dynamics(
                z_0_lig, xh_pocket, t_zeros, ligand['mask'], pocket['mask'], context)
    ...
    def sample_p_zs_given_zt(self, s, t, zt_lig, xh0_pocket, ligand_mask,
                             pocket_mask, fix_noise=False, context=None):
        ...
        if self.cf_guidance and self.cf_strength > 0:
            ...
            n_pocket_nodes = xh0_pocket.shape[0]
            ...
            eps_t_lig_all, eps_t_pocket_all = self.dynamics(
                zt_lig.repeat(2,1), xh0_pocket.repeat(2,1), t.repeat(2,1),
            ...
            eps_t_lig, eps_t_pocket = self.dynamics(
                zt_lig, xh0_pocket, t, ligand_mask, pocket_mask, context)
    ...
    def sample_given_pocket(self, pocket, num_nodes_lig, return_frames=1,
        ...
        if self.class_cond:
            ...
            pocket_context = utils.generate_context_vector(
                pocket['labels'], pocket['n_classes'], pocket['size'].to(device), self.cf_threshold
            ) 
            context = torch.cat([
        ...
        for s in reversed(range(0, timesteps)):
            ...
            z_lig, xh_pocket = self.sample_p_zs_given_zt(
                s_array, t_array, z_lig, xh_pocket, lig_mask, pocket['mask'], context=context)
        ...
        x_lig, h_lig, x_pocket, h_pocket = self.sample_p_xh_given_z0(
            z_lig, xh_pocket, lig_mask, pocket['mask'], n_samples, context=context)
